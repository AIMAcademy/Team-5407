...
public class Winch extends PIDSubsystem {
	...
	double pidLimitTop = 0.4;
	double pidLimitBottom = 0.9;
...
//}
	...
	public void driveWinch(double speed) {
		...
		if(OI.getStickY() < -0.1){
			if(RobotMap.winchLimitBottom.get() == false || potentiometer.get() > pidLimitBottom) {
				victor.set(0);
			}
			else {
				victor.set(speed);
	...
	public void towerTilt(boolean state) {
		solenoid_tower_tilt.set(state);
	}
	public void forkliftOpen(boolean state) {
		solenoid_forklift_open.set(state);
	}
